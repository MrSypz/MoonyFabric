...
public class GuardianTridentEntity extends ElderTridentEntity {
    ...
    public void tick() {
        ...
        if (timeSinceTracking >= 40) {
            ...
            List<LivingEntity> possibleTargets = this.getWorld().getEntitiesByClass(LivingEntity.class, box, (entity) -> entity.canHit() && entity != this.getOwner() && !(entity instanceof TameableEntity && ((TameableEntity) entity).isTamed()));

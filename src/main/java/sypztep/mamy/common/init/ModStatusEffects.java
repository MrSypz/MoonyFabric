...
public class ModStatusEffects {
    ...
    public static StatusEffect CARVE = new EmptyStatusEffect(StatusEffectCategory.HARMFUL,0).addAttributeModifier(EntityAttributes.GENERIC_ARMOR,"9f66ca04-e8c5-4225-952c-665ccb332fe7",-5.0D, EntityAttributeModifier.Operation.ADDITION);

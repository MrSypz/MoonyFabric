...
public class ModStatusEffects {
    ...
    public static StatusEffect FERVOR_OF_BATTLE = new TempoStatusEffect()
            .addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE,"28E38CA1-61D3-4E65-98CD-D15DF2E33CF3",1.0D, EntityAttributeModifier.Operation.ADDITION);
    public static StatusEffect CARVE = new MarkStatusEffect()
            .addAttributeModifier(EntityAttributes.GENERIC_ARMOR,"9f66ca04-e8c5-4225-952c-665ccb332fe7",-0.05D, EntityAttributeModifier.Operation.MULTIPLY_TOTAL);
    public static StatusEffect HOLLOW_POWER = new EmptyStatusEffect(StatusEffectCategory.BENEFICIAL,0)
            .addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE,"52f38a34-b1a7-4a65-928e-8a30608b7432",0.08D, EntityAttributeModifier.Operation.MULTIPLY_BASE)
